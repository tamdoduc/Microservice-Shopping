...
namespace Product.Service.Dtos
{
    ...
    public record CreateProductDto(Guid Id, Guid IdAccount, string NameProduct,string Image, int MinPrice,int MaxPrice, int CountSold, double CountStar, int Discount);
